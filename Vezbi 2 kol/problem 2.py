...
if __name__ == '__main__':
    ...
    n = 0.85
    # print(dataset)
    train_set = dataset[:int(len(dataset) * n)]
    test_set = dataset[int(len(dataset) * n):]
    ...
    el = list(map(float , input().split()))
    print(classifier.predict([el])[0])
    print(classifier.predict_proba([el]))